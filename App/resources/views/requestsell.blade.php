...
@section('content')
    @if($item->status == 'NOT_RELEVANT' )
        <div class="mt-5 font-semibold">Заявка не актуальна</div>
    @endif
    <div class="mt-10 flex justify-between">
        ...
        <div class="w-1/2">
            <form method="POST" action="{{url()->current().'/request'}}">
                @csrf
                <textarea name="body" placeholder="Сообщение/вопрос заказчику..." class="shadow rounded-md bg-gray-100 w-full h-5/6 p-3 resize-none text-gray-600"></textarea>
